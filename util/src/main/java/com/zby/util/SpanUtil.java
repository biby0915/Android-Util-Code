...
public final class SpanUtil {
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setTextColor(@ColorInt final int color) {
     ...
     *
     * @param size The size of font.
     * @param isDp True to use sp, false to use pixel.
     * @return the single {@link SpanUtil} instance
     */
...
//            }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(AppUtil.getApplication().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            AppUtil.getApplication().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(AppUtil.getApplication().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(AppUtil.getApplication(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
